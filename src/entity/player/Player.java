...
public class Player implements Entity {
    ...
    public void setPlayerValues(){
        this.setPlayerValues(100,100,4);
    }
    ...
    public void move(){
        ...
        position.setDx(0);
        position.setDy(0);
        if(keyHandler.getPressed("w")){
            position.setDy(-playerSpeed);
        }
        if(keyHandler.getPressed("a")){
            position.setDx(-playerSpeed);
        }
        if(keyHandler.getPressed("s")){
            position.setDy(playerSpeed);
        }
        if(keyHandler.getPressed("d")){
            position.setDx(playerSpeed);
        }
        pos().move();
    }
